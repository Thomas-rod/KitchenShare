...
roxane_kitchen = Kitchen.new(city: "Paris", address: "4 rue des Prêtres Saint-Séverin, 75005", capacity: 1, user: roxane, description: "Cuisine qui fait l'affaire avec vue sur le Panthéon", name: "Roxane's kitchen", equipment: "Micro-ondes, Plaques, Fouet, Moule", price_by_hour: 5)
...
roxane_kitchen.save
thomas_kitchen = Kitchen.create!(city: "Paris", address: "14 rue des Lyonnais, 75005", capacity: 2, user: thomas, description: "Superbe cuisine bien aménagée et très peu utilisée", name: "Thomas' kitchen", equipment: "Four, Micro-ondes, Plaques, Nombreux plats", price_by_hour: 10)
...
thomas_kitchen.save
john_kitchen = Kitchen.create!(city: "Bezons", address: "2 avenue d'Argenteuil, 95870", capacity: 2, user: john, description: "Meilleure cuisine de Bezons", name: "John's kitchen", equipment: "Four, Plaques, Bols, Collection de couteaux", price_by_hour: 10)
...
renaud_kitchen.save
eniko_kitchen = Kitchen.create!(city: "Paris", address: "24 Place Saint-Pierre, 75018", capacity: 6, user: eniko, description: "Grande cuisine, parfait pour la famille et les amis", name: "Eniko's kitchen", equipment: "Plaques au gaz, Plats, Robots, Casseroles", price_by_hour: 20)
...
eniko_kitchen.save
lital_kitchen = Kitchen.create!(city: "Paris", address: "13 rue de Vaugirard, 75006", capacity: 3, user: lital, description: "Cuisine parisienne équipée mais très peu utilisée", name: "Lital's kitchen", equipment: "Micro-ondes, Four, Plats", price_by_hour: 6)
